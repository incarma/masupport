# django_ma/commission/services/rate_example_normalizers/fire_hanhwa.py
...
def _build_rows_from_table(
    *,
    ...
    # 일반 테이블은 header_row + 2부터 데이터가 시작된다.
    # 단일 환산율 헤더 테이블은 header_row + 1부터 데이터가 시작될 수 있으므로 둘 다 허용한다.
...
def build_fire_hanhwa_conversion_rows(
    ...
    for ws in wb.worksheets:
        ...
        for r in range(1, ws.max_row + 1):
            # B열 값이 "구분"인 행만 상품 테이블 헤더로 본다.
            # raw에는 "구  분"처럼 공백이 포함될 수 있으므로 _norm_key 사용.
